void replay_KaonLT_coin_scalers (Int_t RunNumber = 0, Int_t MaxEvent = 0,Int_t FirstEvent=1) {
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/Scalers/coin_KaonLT_replay_scalers_%d_%d.root";
